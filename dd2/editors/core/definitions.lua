...
definitions.override('dd2', {
    ...
    ['app.GimmickParamBase'] = {
        abstract = {
            'app.Gm05_046Param',
            'app.Gm09_001Param',
            'app.Gm51_115Param',
            'app.Gm51_568Param',
            'app.Gm59_000_01Param',
            'app.Gm80_001Param',
            'app.Gm80_003Param',
            'app.Gm80_019Param',
            'app.Gm80_042Param',
            ...
            'app.Gm83_003Param',
            'app.Gm83_021Param',
            'app.GmBreakForestWallParam',
            'app.GmCommonTrapParam',
        }
    },
    ['app.Ch200000Parameter'] = {
        abstract = {
            'app.Ch220Parameter',
            'app.Ch221Parameter',
            'app.Ch222Parameter',
            ...
            'app.Ch259Parameter',
            'app.Ch260Parameter',
            'app.Ch299003Parameter',
            'app.Ch299010Parameter',
            'app.Ch299011Parameter',
            'app.Ch299020Parameter',
            'app.Ch299030Parameter',
            'app.Ch299200Parameter',
            'app.Ch299210Parameter',
            'app.Ch299220Parameter',
            'app.Ch299230Parameter',
            'app.Ch299240Parameter',
            'app.Ch299400Parameter',
            'app.Ch299410Parameter',
            'app.Ch299420Parameter',
            'app.Ch299430Parameter',
        }
    },

    ['app.EmThkCommandBase'] = {
        abstract = {
            'app.EmThkActRowCommand',
            'app.EmThkChkRowCommand',
            'app.EmThkGeneralCommand',
            'app.EmThkRowCommand',
            'app.EmThkSPE_ACTNOPASS_OFF',
            'app.EmThkSPE_ACTNOPASS_ON',
            'app.EmThkSPE_CHK_BOOL',
            'app.EmThkSPE_CHK_FALSE',
            'app.EmThkSPE_CHK_FLOAT',
            'app.EmThkSPE_CHK_GROUP_TIMER',
            'app.EmThkSPE_CHK_INT',
            'app.EmThkSPE_CHK_RANGE',
            'app.EmThkSPE_CHK_STOP',
            'app.EmThkSPE_CHK_TARGET_TYPE',
            'app.EmThkSPE_CHK_TRUE',
            'app.EmThkSPE_CLEAR_TARGET',
            'app.EmThkSPE_GetDestinationPoint',
            'app.EmThkSPE_NaviTrace_Off',
            'app.EmThkSPE_NaviTrace_On',
            'app.EmThkSPE_ReqDestinationPoint',
            'app.EmThkSPE_SET_BOOL',
            'app.EmThkSPE_SET_FLOAT',
            'app.EmThkSPE_SET_INT',
            'app.EmThkSPE_SET_MAIN_TBL',
            'app.EmThkSPE_SET_RESET_TBL',
            'app.EmThkSPE_SET_TARGET_OFFSET',
            'app.EmThkSPE_SET_TARGET_TYPE',
            'app.EmThkSPE_SET_TIMER',
            'app.EmThkSPE_SetGenerateInfoFlag',
        }
    },
    ['app.StatusConditionActionParamBase'] = {
        abstract = {
            'app.StatusConditionActionParaWorkRate',
            'app.StatusConditionActionParamBattleRelationShipGroup',
            'app.StatusConditionActionParamCreateShell',
            'app.StatusConditionActionParamDamageAdjust',
            'app.StatusConditionActionParamDamageEndurance',
            'app.StatusConditionActionParamDirectDamage',
            'app.StatusConditionActionParamEffectCall',
            'app.StatusConditionActionParamEffectCallEndurance',
            'app.StatusConditionActionParamEnchant',
            'app.StatusConditionActionParamEnduranceWorkRate',
            'app.StatusConditionActionParamRequestAction',
            'app.StatusConditionActionParamRequestStatusCondition',
            'app.StatusConditionActionParamSECall',
            'app.StatusConditionActionParamSECallEndurance',
            'app.StatusConditionActionParamSleep',
            'app.StatusConditionActionParamSlipDamage',
            'app.StatusConditionActionParamStampAndMatrialRequest',
            'app.StatusConditionActionParamStone',
            'app.StatusConditionActionParamTimeRecover',
    ...
    ['app.Context'] = {
        abstract = {
            'app.AbilityContext',
            'app.BodyDetailContext',
            'app.BodyEditContext',
            'app.CatchContext',
            'app.Ch220CharaEditIDContext',
            'app.Ch220Context',
            'app.Ch229Context',
            'app.Ch230100Context',
            'app.Ch230AppearanceContext',
            'app.Ch230VoiceContext',
            'app.Ch251Context',
            'app.Ch252Context',
            'app.Ch253Context',
            'app.Ch255000Context',
            'app.Ch259000Context',
            'app.Ch259000ModelContext',
            'app.Ch299003Context',
            'app.CharacterDamageContext',
            'app.CharacterGroupContext',
            'app.CharacterIDContext',
            'app.CharacterPosRotContext',
            'app.CharacterQuestContext',
            'app.CorpseContext',
            'app.CurrentActionContext',
            'app.DeadCharacterContext',
            'app.DragonHermitContext',
            'app.DropPartsContext',
            'app.FaceEditContext',
            'app.GatherContext',
            'app.GenerateInfoContext',
            'app.GimmickContext',
            'app.GimmickHolderContext',
            'app.GimmickPosRotContext',
            'app.Gm81_004Context',
            'app.Gm82_000_01Context',
            'app.GmItemContext',
            'app.HitControllerContext',
            'app.HumanDirtContext',
            'app.HumanSkillContext',
            'app.HumanSpecialBuffContext',
            'app.HumanStatusContext',
            'app.HumanWeightRankContext',
            'app.Job04ActionContext',
            'app.Job05ActionContext',
            'app.Job07ActionContext',
            'app.Job08ActionContext',
            'app.Job09ActionContext',
            'app.JobContext',
            'app.JobMagicUserActionContext',
            'app.LanternContext',
            'app.LocomotionSpeedContext',
            'app.MainPawnDataContext',
            'app.NetworkIDContext',
            'app.ObjectClimberContext',
            'app.PartSwapHumanContext',
            'app.PawnCountDataContext',
            'app.PawnDataContext',
            'app.PawnKnowledgeContext',
            'app.PawnOwnerContext',
            'app.PawnQuestContext',
            'app.PetrificationDeadContext',
            'app.PlayerPersonalDataContext',
            'app.PosRotOnOxcartContext',
            'app.PretenderContext',
            'app.RevivePawnContext',
            'app.ScaleContext',
            'app.StaminaContext',
            'app.StatusConditionContext',
            'app.SubPawnDataContext',
            'app.TalkGimmickContext',
            'app.TargetAngleContext',
            'app.ThinkTableContext',
            'app.TreasureBoxGimmickContext',
            'app.UniqueIDContext',
            'app.WeaponContext',
            'app.WeaponDrawContext',
            'app.ch223001Context',
            'app.gm252_000Context',
        },
    },

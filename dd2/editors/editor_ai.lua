...
if core.editor_enabled then
    ...
    editor.define_window('ai_overview', 'AI Overview', function (state)
        ...
        imgui.indent(4)
        imgui.begin_rect()
        ui.handlers.show_editable(utils.gameobject.get_component(pawnAiGo, 'app.PawnUpdateController'), 'AIGoalActionData', nil, 'Goal data')
        ui.handlers.show_editable(utils.gameobject.get_component(pawnAiGo, 'app.PawnBattleController'), '_BattleAIData', nil, 'Battle data')
        ui.handlers.show_editable(utils.gameobject.get_component(pawnAiGo, 'app.PawnOrderController'), 'OrderData', nil, 'Order data')
        ui.handlers.show_readonly(utils.gameobject.get_component(pawnAiGo, 'app.PawnOrderTargetController')--[[@as any]], nil, 'Order target controller')
        ui.handlers.show_readonly(utils.gameobject.get_component(pawnAiGo, 'app.AIMetaController')--[[@as any]], nil, 'Meta controller')
        imgui.end_rect(2)
        imgui.unindent(4)
    end)
end

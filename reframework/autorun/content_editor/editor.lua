...
local editor_defs = {
    user = {
        ...
        draw = function ()
            ...
            local alertsChanged = imgui_wrappers.setting_checkbox('Disable alert for missing editors', config.data.editor, 'disable_unknown_entity_alerts', config.save, "Disable the error message when unknown entity types are found.")
            ...
            if devmodeChanged or alertsChanged or show_property_labels then
